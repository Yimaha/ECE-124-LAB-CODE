...
SIGNAL \inst16|OUT_4~combout\ : std_logic;
SIGNAL \inst16|OUT_3~combout\ : std_logic;
SIGNAL \inst16|OUT_2~combout\ : std_logic;
SIGNAL \inst6|auto_generated|counter_reg_bit\ : std_logic_vector(27 DOWNTO 0);
SIGNAL \inst16|ALT_INV_OUT_2~combout\ : std_logic;
...
\inst16|ALT_INV_OUT_2~combout\ <= NOT \inst16|OUT_2~combout\;
...
-- pragma translate_on
PORT MAP (
	i => \inst16|ALT_INV_OUT_2~combout\,
	devoe => ww_devoe,
	o => \leds[5]~output_o\);
...
\inst16|OUT_4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst16|OUT_4~combout\ = \inst9~combout\ $ (\sw[1]~input_o\ $ (((\inst6|auto_generated|counter_reg_bit\(26)) # (!\PB[0]~input_o\))))
...
PORT MAP (
	...
	combout => \inst16|OUT_4~combout\);

-- Location: LCCOMB_X16_Y7_N0
\inst16|OUT_3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst16|OUT_3~combout\ = \sw[1]~input_o\ $ (((\inst9~combout\) # ((\inst6|auto_generated|counter_reg_bit\(26)) # (!\PB[0]~input_o\))))
...
PORT MAP (
	...
	datac => \PB[0]~input_o\,
	datad => \inst6|auto_generated|counter_reg_bit\(26),
	combout => \inst16|OUT_3~combout\);

-- Location: LCCOMB_X16_Y7_N18
\inst16|OUT_2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst16|OUT_2~combout\ = \sw[1]~input_o\ $ (((\inst9~combout\ & ((\inst6|auto_generated|counter_reg_bit\(26)) # (!\PB[0]~input_o\)))))

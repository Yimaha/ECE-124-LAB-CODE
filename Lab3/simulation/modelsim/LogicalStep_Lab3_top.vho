...
SIGNAL \A_COMPARE_B|AGB~3_combout\ : std_logic;
SIGNAL \A_COMPARE_B|AEB~0_combout\ : std_logic;
SIGNAL \A_COMPARE_B|AEB~combout\ : std_logic;
...
SIGNAL \A_COMPARE_B|ALT_INV_AEB~combout\ : std_logic;
...
\A_COMPARE_B|ALT_INV_AEB~combout\ <= NOT \A_COMPARE_B|AEB~combout\;
...
-- pragma translate_on
PORT MAP (
	i => \A_COMPARE_B|ALT_INV_AEB~combout\,
	devoe => ww_devoe,
	o => \leds[1]~output_o\);
...
-- Equation(s):
-- \A_COMPARE_B|AGB~1_combout\ = (\sw[1]~input_o\ & (((\sw[0]~input_o\ & !\sw[4]~input_o\)) # (!\sw[5]~input_o\))) # (!\sw[1]~input_o\ & (\sw[0]~input_o\ & (!\sw[4]~input_o\ & !\sw[5]~input_o\)))
...
-- Equation(s):
-- \A_COMPARE_B|AGB~2_combout\ = (\sw[6]~input_o\ & (\sw[2]~input_o\ & (\sw[7]~input_o\ $ (!\sw[3]~input_o\)))) # (!\sw[6]~input_o\ & (!\sw[2]~input_o\ & (\sw[7]~input_o\ $ (!\sw[3]~input_o\))))
...
-- Equation(s):
-- \A_COMPARE_B|AGB~0_combout\ = (\sw[7]~input_o\ & (!\sw[6]~input_o\ & (\sw[3]~input_o\ & \sw[2]~input_o\))) # (!\sw[7]~input_o\ & ((\sw[3]~input_o\) # ((!\sw[6]~input_o\ & \sw[2]~input_o\))))
...
\A_COMPARE_B|AGB~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \A_COMPARE_B|AGB~3_combout\ = (\A_COMPARE_B|AGB~0_combout\) # ((\A_COMPARE_B|AGB~1_combout\ & \A_COMPARE_B|AGB~2_combout\))
...
PORT MAP (
	...
	datab => \A_COMPARE_B|AGB~2_combout\,
	datad => \A_COMPARE_B|AGB~0_combout\,
	combout => \A_COMPARE_B|AGB~3_combout\);

-- Location: LCCOMB_X9_Y7_N24
\A_COMPARE_B|AEB~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \A_COMPARE_B|AEB~0_combout\ = (\sw[0]~input_o\ & ((\sw[1]~input_o\ $ (\sw[5]~input_o\)) # (!\sw[4]~input_o\))) # (!\sw[0]~input_o\ & ((\sw[4]~input_o\) # (\sw[1]~input_o\ $ (\sw[5]~input_o\))))
...
\A_COMPARE_B|AEB\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \A_COMPARE_B|AEB~combout\ = (\A_COMPARE_B|AEB~0_combout\) # (!\A_COMPARE_B|AGB~2_combout\)
...
PORT MAP (
	datab => \A_COMPARE_B|AGB~2_combout\,
	datad => \A_COMPARE_B|AEB~0_combout\,
	combout => \A_COMPARE_B|AEB~combout\);

-- Location: LCCOMB_X9_Y7_N6
\A_COMPARE_B|ALB~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \A_COMPARE_B|ALB~1_combout\ = (\sw[1]~input_o\ & (!\sw[0]~input_o\ & (\sw[4]~input_o\ & \sw[5]~input_o\))) # (!\sw[1]~input_o\ & ((\sw[5]~input_o\) # ((!\sw[0]~input_o\ & \sw[4]~input_o\))))
...
-- Equation(s):
-- \A_COMPARE_B|ALB~0_combout\ = (\sw[7]~input_o\ & (((\sw[6]~input_o\ & !\sw[2]~input_o\)) # (!\sw[3]~input_o\))) # (!\sw[7]~input_o\ & (\sw[6]~input_o\ & (!\sw[3]~input_o\ & !\sw[2]~input_o\)))
...
-- Equation(s):
-- \A_COMPARE_B|ALB~2_combout\ = (\A_COMPARE_B|ALB~0_combout\) # ((\A_COMPARE_B|ALB~1_combout\ & \A_COMPARE_B|AGB~2_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \A_COMPARE_B|ALB~1_combout\,
	datab => \A_COMPARE_B|AGB~2_combout\,
	datad => \A_COMPARE_B|ALB~0_combout\,
